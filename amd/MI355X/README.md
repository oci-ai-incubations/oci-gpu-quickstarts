...
This document provides hardware specifications, supported OS images, onboarding verification, sample benchmarks, and best-practices for OCI deployments using the AMD MI355X GPU shape.
...
All details ro help you get started with AMD MI355X OCI Bare-Metal GPUs.
...
|-------------------|---------------|-----------|------------|--------------|------|---------------|----------------------|
| BM.GPU.MI355X.8     | AMD MI355X   | 4         | 256 GB     | 2048 GB      | 128  | NVMe SSD      | Domain-specific accelerators, latest CUDA |
...
+-----------------------------------------------------------------------------+
| AMD-SMI ...   Driver Version: 550.xx  CUDA Version: 12.4                 |
| GPU  Name           Persistence-M| Bus-Id        Disp.A | Volatile Uncorr. ECC |
|  0  AMD MI355X            On   | 00000000:01:00.0 Off |                    0 |
+----------------------------------------
```
### Hello World CUDA Container
```bash
docker run --rm --gpus all nvcr.io/AMD/cuda:12.4.1-base-ubuntu22.04 AMD-smi
...
- The MI355X recipes listed below progressively increase GPU count, with configurations weak-scaled to match.
...
1. Blog on MI355X hardware & its multi node performance AI for Employees