...
All details ro help you get started with NVIDIA GB200 OCI Bare-Metal GPUs.
...
|-------------------|---------------|-----------|------------|--------------|------|---------------|----------------------|
| BM.GPU.GB200.4     | NVIDIA GB200   | 4         | 192 GB     | 2048 GB      | 128  | NVMe SSD      | Domain-specific accelerators, latest CUDA |
...
|  0  NVIDIA GB200            On   | 00000000:01:00.0 Off |                    0 |
+----------------------------------------
```
...
2. Add GPU Node Pool: Choose GB200 shape, use golden OS image.
